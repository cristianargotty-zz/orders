...
import { success } from '../../actions/orders/create';
import { retrieve, update, reset } from '../../actions/orders/update';
...
const mapStateToProps = (state) => {
  return {
    retrieveError: state.orders.update.retrieveError,
    retrieveLoading: state.orders.update.retrieveLoading,
    updateError: state.orders.update.updateError,
    updateLoading: state.orders.update.updateLoading,
    deleteError: state.orders.del.error,
    deleteLoading: state.orders.del.loading,
    created: state.orders.create.created,
    deleted: state.orders.del.deleted,
    retrieved: state.orders.update.retrieved,
    updated: state.orders.update.updated,
  };
};
