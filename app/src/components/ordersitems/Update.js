...
import { success } from '../../actions/ordersitems/create';
import { retrieve, update, reset } from '../../actions/ordersitems/update';
...
const mapStateToProps = (state) => {
  return {
    retrieveError: state.ordersitems.update.retrieveError,
    retrieveLoading: state.ordersitems.update.retrieveLoading,
    updateError: state.ordersitems.update.updateError,
    updateLoading: state.ordersitems.update.updateLoading,
    deleteError: state.ordersitems.del.error,
    deleteLoading: state.ordersitems.del.loading,
    created: state.ordersitems.create.created,
    deleted: state.ordersitems.del.deleted,
    retrieved: state.ordersitems.update.retrieved,
    updated: state.ordersitems.update.updated,
  };
};
