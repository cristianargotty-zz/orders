...
import { success } from '../../actions/payments/create';
import { retrieve, update, reset } from '../../actions/payments/update';
...
const mapStateToProps = (state) => {
  return {
    retrieveError: state.payments.update.retrieveError,
    retrieveLoading: state.payments.update.retrieveLoading,
    updateError: state.payments.update.updateError,
    updateLoading: state.payments.update.updateLoading,
    ...
    retrieved: state.payments.update.retrieved,
    updated: state.payments.update.updated,
  };
};
