...
import { success } from '../../actions/personaddress/create';
import { retrieve, update, reset } from '../../actions/personaddress/update';
...
const mapStateToProps = (state) => {
  return {
    retrieveError: state.personaddress.update.retrieveError,
    retrieveLoading: state.personaddress.update.retrieveLoading,
    updateError: state.personaddress.update.updateError,
    updateLoading: state.personaddress.update.updateLoading,
    ...
    retrieved: state.personaddress.update.retrieved,
    updated: state.personaddress.update.updated,
  };
};
